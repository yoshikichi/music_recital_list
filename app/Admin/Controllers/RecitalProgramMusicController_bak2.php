...
//        $grid->model()->whereIn('recital_id',$rctenbl_ids)->orderBy('recital_id')->orderBy('age')->orderBy('player_id')->orderBy('rank');
        ...
        $grid->model()->join('players', 'players.id', '=', 'recital_program_musics.player_id');
		$grid->model()->whereIn('recital_id',$rctenbl_ids);
		$grid->model()->orderBy('recital_id')->orderBy('player_id')->orderBy('players.birthday','DESC')->orderBy('rank');
    ...
    protected function detail($id)
    {
        ...
        $show->player_id('楽曲名')->as(function ($tid) {
