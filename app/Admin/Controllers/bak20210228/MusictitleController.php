...
class MusictitleController extends Controller
{
    ...
    protected function grid()
    {
		...
		$grid->collectedby('所収本')->sortable();
        $grid->dfc_level('難易度')->sortable();
    ...
    protected function form()
    {
		...
		$form->text('collectedby', '所収本');
        $form->number('dfc_level', '難易度(0～100)')->default(0)->rules('required|between:0,100');
